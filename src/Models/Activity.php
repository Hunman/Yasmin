...
class Activity extends ClientBase {
    ...
    function __construct(\CharlotteDunois\Yasmin\Client $client, array $activity) {
        ...
        $this->applicationID = \CharlotteDunois\Yasmin\Utils\DataHelpers::typecastVariable(($activity['application_id'] ?? null), 'int');
        $this->details = \CharlotteDunois\Yasmin\Utils\DataHelpers::typecastVariable(($activity['details'] ?? null), 'int');

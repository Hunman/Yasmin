 ...
 * @property \CharlotteDunois\Collect\Collection         $members             A collection of all (cached) guild members which have the role (executes filtering on the guild members).
 */
